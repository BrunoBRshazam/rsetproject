...
#rset Dependencies Auto-Installer v02 - By Bruno Guimaraes [Cyberbot13] [Muito obrigado]"
...
function mostrarheader(){
	...
	echo -e "$red                          ██║  ██║███████║███████╗   ██║   "
	echo -e "$red                          ╚═╝  ╚═╝╚══════╝╚══════╝   ╚═╝   "
	echo -e "$white                Rset Dependencies Auto-Installer v02"
	echo -e "$green  v2018.1  By Bruno Guimaraes [Cyberbot13] $transparent"
	echo
	echo
